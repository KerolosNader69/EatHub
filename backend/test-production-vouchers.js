...
const PRODUCTION_API = 'https://backend-ljhd8p024-kerolosnader69s-projects.vercel.app';

console.log('🧪 Testing Production Vouchers API\n');
console.log(`API: ${PRODUCTION_API}\n`);

function testAPI() {
  return new Promise((resolve, reject) => {
    const timestamp = Date.now();
    const url = `${PRODUCTION_API}/api/vouchers/available?_t=${timestamp}`;
